...
\end{minted}
\noindent
The corresponding tree visualization of \cinl{exAddSharedCoin4} looks as follows.
...
\todo{Add section that elaborates on a pair as state}

\paragraph{Resetting the State}
